      ...
      <html ⚡4email data-css-strict>
        ...
        height="30" style="object-fit:contain;background-color:#d3d3d3" layout="fixed" src="https://knotopian.com/wp-content/uploads/2022/05/3.png" >
            ...
            <div [class]="questionsState.selectedQuestion == 1 ? 'show' : 'hide'" style="margin-bottom: 20px">
              ...
              <br/>
            <label for="q1yes">
            <input type="radio" id="q1yes" style="background-color: #007bff;color:#007bff" name="question1" value="yes"   on="change:AMP.setState({questionsState: {showLink:true} })"> Yes
           </label>
            <label for="q1no">
            <input type="radio" id="q1no" name="question1" value="no"   on="change:AMP.setState({questionsState: {selectedQuestion: 2} })"> No
          </label>
            ...
            <input type="radio" id="q4yes" name="question4" value="yes"   on="change:AMP.setState({questionsState:  {showLink:true} })"> Yes
               ...
               <label for="q4no">
            <input type="radio" id="q4no" name="question4" value="no"   on="change:AMP.setState({questionsState: {selectedQuestion: 5} })"> No
          </label>
            </div>
